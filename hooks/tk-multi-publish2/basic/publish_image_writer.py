...
class GafferImageWriterPublishPlugin(HookBaseClass):
    """
    ...
    def settings(self):
        ...
        base_settings = super(GafferImageWriterPublishPlugin, self).settings or {}
        ...
        gaffer_publish_settings = {
            "Publish Template": {
                "type": "template",
                "default": None,
                "description": "Template path for ImageWriter files. Should"
    ...
    def validate(self, settings, item):
        ...
        return super(GafferImageWriterPublishPlugin, self).validate(settings, item)
    ...
    def publish(self, settings, item):
        ...
        super(GafferImageWriterPublishPlugin, self).publish(settings, item)
