...
class AggregateTests(unittest.TestCase):
    ...
    def CheckAggrNoFinalize(self):
        ...
        try:
            ...
            self.assertEqual(
                e.args[0], "user-defined aggregate's 'finalize' method raised error"
            )
    ...
    def CheckAggrExceptionInInit(self):
        ...
        try:
            ...
            self.assertEqual(
                e.args[0], "user-defined aggregate's '__init__' method raised error"
            )
    ...
    def CheckAggrExceptionInStep(self):
        ...
        try:
            ...
            self.assertEqual(
                e.args[0], "user-defined aggregate's 'step' method raised error"
            )
